...
Route::group(['namespace' => 'App\Http\Controllers\API', 'middleware' => 'auth:api'], function () {
    Route::apiResource('customer', CustomerController::class)->middleware(['scope:customer']);
    Route::apiResource('invoice', InvoiceController::class)->middleware(['scope:invoice']);
